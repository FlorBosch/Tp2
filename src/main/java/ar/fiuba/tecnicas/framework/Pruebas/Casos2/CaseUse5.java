...
public class CaseUse5 implements TestCreator {
	...
	// de modo que solo se ejecuten los test que tienen el tag DB y que
	// contengan en algun lugar
	// la palabra "mysql"
	// solo se ejecutaron los test T4 ("test con mysql 1 case") y T5
	// ("test con mysql 2 use")

...
public class XmlPrinter implements TestListener {
    ...
    private void printTestCaseWithError(Test test, String time,
	...
	printer.print("\t\t\t\t\t\t<xs:attribute name=\"" + nameCase
	...
	printer.print("\t\t\t<xs:attribute name=\"" + name
		+ "\" type=\"xs:string\" use=\"optional\"/>"
		+ "\n\t\t</xs:complexType>\n  \t</xs:element>");
	...
	if (namesTestSuites.isEmpty()) {
	    System.out
		    .print(" xmlns:xsi=\"http://www.w3c.org/2001/XMLSchema-instance\"");
	}
	printer.println(">\n\t<xs:complexType>\n" + "\t\t<xs:sequence>");
    }
}
